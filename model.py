...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        '''
        # input in pytoch is 2D or 3D.
        #https://stackoverflow.com/questions/53500511/valueerror-expected-2d-or-3d-input-got-1d-input-pytorch
        #x = x[None, ...]
        ...
        x = F.relu(self.fc2(x))
        x = F.relu(self.fc3(x))
        x = F.tanh(self.fc4(x)) #restrict output to (-1,1)
